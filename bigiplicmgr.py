...
parser.add_argument('--licmgr_ip', help='F5 license manager IP Address', required=False)
parser.add_argument('--licmgr_adm', help='F5 license manager admin username', required=False)
parser.add_argument('--licmgr_pwd', help='F5 license manager admin password', required=False)
